...
if __name__ == "__main__": 
    ...
    clear = Button(gui, text='C', fg='white', bg='grey', 
    ...
    parenthes_open=Button( gui,text='(', fg='white', bg='grey',
                        command=lambda: press('('), height=2,width=7)
    parenthes_open.grid(row=6, column=1)

    parenthes_close=Button( gui,text=')', fg='white', bg='grey',
                        command=lambda: press(')'), height=2,width=7)
    parenthes_close.grid(row=6, column=2)
